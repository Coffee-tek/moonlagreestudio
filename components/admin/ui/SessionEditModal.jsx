...
export default function SessionEditModal({ session, onClose, onSave, teachers = [] }) {
  ...
  const handleChange = (e) => {
    ...
    // Recalculer les places restantes si totalPlaces change
    if (name === "totalPlaces") {
      const newTotal = parseInt(value) || 0;
      const booked = formData.bookedPlaces || 0;
  ...
  const validateForm = () => {
    ...
    const totalPlaces = parseInt(formData.totalPlaces) || 0;
    const bookedPlaces = parseInt(formData.bookedPlaces) || 0;

    if (totalPlaces < 1 || totalPlaces > 50) {
      newErrors.totalPlaces = "Le nombre de places doit être entre 1 et 50";
    }

    if (totalPlaces < bookedPlaces) {
      newErrors.totalPlaces = "Le nombre total de places ne peut pas être inférieur aux places réservées";
    }
              ...
              <div className="row">
                <div className="col-md-4 text-center mb-4">
                  <div className="avatar-preview mb-3">
                    <Image
                      src={formData.teacherAvatar || session.teacherAvatar}
                    ...
                    <div className="card-body p-3">
                      ...
                      <div className="mb-2">
                        <div className="d-flex justify-content-between mb-1">
                          ...
                          <small className="fw-bold">{formData.bookedPlaces || 0}</small>
                        </div>
                        <div className="d-flex justify-content-between mb-1">
                          <small>Restantes</small>
                          <small className="fw-bold text-success">{formData.remainingPlaces || 0}</small>
                        </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <small className="text-muted">
                        Places réservées actuellement : {formData.bookedPlaces || 0}
                      </small>
                    </div>
                  </div>
